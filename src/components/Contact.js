              ...
              <form name="contact" netlify> 
                <Row>
                  <Col size={12} sm={6} className="px-1">
                    <input type="text" name="firstaname" placeholder="First Name" data-aos="zoom-in-right" required />
                  </Col>
                  <Col size={12} sm={6} className="px-1">
                    <input type="text" name="lastaname" placeholder="Last Name" data-aos="zoom-in-right" required />
                  </Col>
                  <Col size={12} sm={6} className="px-1">
